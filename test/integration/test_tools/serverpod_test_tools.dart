...
class TestEndpoints {
  ...
  late final _NabiEndpoint nabi;

  late final _SiraEndpoint sira;
...
class _AuthEndpoint {
  ...
  _i3.Future<Map<String, String>> login(
    _i1.TestSessionBuilder sessionBuilder,
    String email,
    String password,
  ) async {
  ...
  _i3.Future<Map<String, String>> refresh(
    _i1.TestSessionBuilder sessionBuilder,
    ...
    return _i1.callAwaitableFunctionAndHandleExceptions(() async {
      ...
      try {
        var _localCallContext = await _endpointDispatch.getMethodCallContext(
          ...
          methodName: 'refresh',
          parameters:
              _i1.testObjectToJson({'refreshTokenStr': refreshTokenStr}),
          serializationManager: _serializationManager,
        );
        var _localReturnValue = await (_localCallContext.method.call(
          _localUniqueSession,
...
class _ChatEndpoint {
  ...
  _i3.Future<String> requestChat(_i1.TestSessionBuilder sessionBuilder) async {
    return _i1.callAwaitableFunctionAndHandleExceptions(() async {
      var _localUniqueSession =
          (sessionBuilder as _i1.InternalTestSessionBuilder).internalBuild(
        endpoint: 'chat',
  ...
  _i3.Future<String> getPendingChats(
      _i1.TestSessionBuilder sessionBuilder) async {
    return _i1.callAwaitableFunctionAndHandleExceptions(() async {
      var _localUniqueSession =
          (sessionBuilder as _i1.InternalTestSessionBuilder).internalBuild(
        endpoint: 'chat',
        method: 'getPendingChats',
      );
      try {
        var _localCallContext = await _endpointDispatch.getMethodCallContext(
          createSessionCallback: (_) => _localUniqueSession,
          endpointPath: 'chat',
          methodName: 'getPendingChats',
          parameters: _i1.testObjectToJson({}),
          serializationManager: _serializationManager,
        );
        var _localReturnValue = await (_localCallContext.method.call(
  ...
  _i3.Future<String> getMyActiveChats(
      _i1.TestSessionBuilder sessionBuilder) async {
    return _i1.callAwaitableFunctionAndHandleExceptions(() async {
      var _localUniqueSession =
          (sessionBuilder as _i1.InternalTestSessionBuilder).internalBuild(
        endpoint: 'chat',
        method: 'getMyActiveChats',
      );
      try {
        var _localCallContext = await _endpointDispatch.getMethodCallContext(
          createSessionCallback: (_) => _localUniqueSession,
          endpointPath: 'chat',
          methodName: 'getMyActiveChats',
          parameters: _i1.testObjectToJson({}),
          serializationManager: _serializationManager,
        );
        var _localReturnValue = await (_localCallContext.method.call(
  ...
  _i3.Future<String> getMyChats(_i1.TestSessionBuilder sessionBuilder) async {
    return _i1.callAwaitableFunctionAndHandleExceptions(() async {
      var _localUniqueSession =
          (sessionBuilder as _i1.InternalTestSessionBuilder).internalBuild(
        endpoint: 'chat',
  ...
  _i3.Future<List<_i6.MaterialFile>> getMaterialsByYear(
    ...
    return _i1.callAwaitableFunctionAndHandleExceptions(() async {
      var _localUniqueSession =
          (sessionBuilder as _i1.InternalTestSessionBuilder).internalBuild(
        endpoint: 'material',
        method: 'getMaterialsByYear',
      );
      try {
        var _localCallContext = await _endpointDispatch.getMethodCallContext(
          createSessionCallback: (_) => _localUniqueSession,
          endpointPath: 'material',
          methodName: 'getMaterialsByYear',
          parameters: _i1.testObjectToJson({'yearName': yearName}),
          serializationManager: _serializationManager,
        );
        var _localReturnValue = await (_localCallContext.method.call(
          _localUniqueSession,
  ...
  _i3.Future<List<_i6.MaterialFile>> getMaterialsByName(
    ...
    return _i1.callAwaitableFunctionAndHandleExceptions(() async {
      var _localUniqueSession =
          (sessionBuilder as _i1.InternalTestSessionBuilder).internalBuild(
        endpoint: 'material',
        method: 'getMaterialsByName',
      );
      try {
        var _localCallContext = await _endpointDispatch.getMethodCallContext(
          createSessionCallback: (_) => _localUniqueSession,
          endpointPath: 'material',
          methodName: 'getMaterialsByName',
          parameters: _i1.testObjectToJson({'materialName': materialName}),
          serializationManager: _serializationManager,
        );
        var _localReturnValue = await (_localCallContext.method.call(
          _localUniqueSession,
...
class _NabiEndpoint {
  ...
  _i3.Future<void> addNabi(
    _i1.TestSessionBuilder sessionBuilder,
    List<String> nabiContents,
  ) async {
    return _i1.callAwaitableFunctionAndHandleExceptions(() async {
      var _localUniqueSession =
          (sessionBuilder as _i1.InternalTestSessionBuilder).internalBuild(
      ...
      try {
        var _localCallContext = await _endpointDispatch.getMethodCallContext(
          ...
          endpointPath: 'nabi',
          methodName: 'addNabi',
          parameters: _i1.testObjectToJson({'nabiContents': nabiContents}),
          serializationManager: _serializationManager,
        );
        var _localReturnValue = await (_localCallContext.method.call(
          _localUniqueSession,
...
class _SiraEndpoint {
  ...
  _i3.Future<void> addSira(
    _i1.TestSessionBuilder sessionBuilder,
    List<String> siraContents,
  ) async {
    return _i1.callAwaitableFunctionAndHandleExceptions(() async {
      var _localUniqueSession =
          (sessionBuilder as _i1.InternalTestSessionBuilder).internalBuild(
      ...
      try {
        var _localCallContext = await _endpointDispatch.getMethodCallContext(
          ...
          endpointPath: 'sira',
          methodName: 'addSira',
          parameters: _i1.testObjectToJson({'siraContents': siraContents}),
          serializationManager: _serializationManager,
        );
        var _localReturnValue = await (_localCallContext.method.call(
          _localUniqueSession,
